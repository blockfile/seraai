...
import loadingGif from "../assets/images/sera.gif";
export default function ThreeRoot() {
    ...
    const fetchIpData = async () => {
        try {
            ...
            setIpData(formattedData);
        } catch (error) {
            setIpData("Unable to fetch IP data.");
    ...
    const displayStartupMessages = () => {
        ...
        const startupMessages = [
            ...
            "CHECKING SERA IF ONLINE... ONLINE.",
            "ACTIVATING SERA... ACTIVATED.",
    ...
    const handleGenerate = async (prompt: string) => {
        ...
        try {
            ...
            setTimeout(() => {
                setGenerations((prev) => [
                    ...prev,
                    { prompt, image: `data:image/png;base64,${data.b64_json}` },
                ]);
                setLoading(false); // Hide the loading GIF after 2 seconds
                setHistory((prev) => [
                    ...prev,
    ...
    return (
        <div
            ...
            <div
                className={`terminal-container ${glitch ? "glitch" : ""}`}
                style={{
                    position: "absolute",
                    top: "10%",
                    left: "10%",
...
╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝      ╚═╝  ╚═╝╚═╝`}
                        ...
                        <div
                            ...
                            <p style={{ margin: 0 }}>
                                SERA-AI ALPHA-V.1.0.3 (C) ALL RIGHTS RESERVED.
                            </p>
                            <p style={{ margin: 0 }}>
                                {"=".repeat(60)}{" "}
                                {/* Repeat '=' programmatically */}
